...
function add_my_menus() {
    register_nav_menus(
    array(
        'header-menu' => __( 'Header Menu', 'montreal-real-estate-helen-tkacheva' ),
        'footer-menu' => __( 'Footer Menu', 'montreal-real-estate-helen-tkacheva' ),
        'social-menu' => __( 'Social Menu', 'montreal-real-estate-helen-tkacheva'),
